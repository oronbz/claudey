...
- Interrupted, disappeared, or uncertain sessions quietly return Claudey to rest through automatic recovery. No warning, badge, or cleanup UI; reserve the questioning pose for confirmed requests for input.
- Claudey is draggable, remembers his position, follows desktop spaces, and stays out of full-screen apps. Movement remains local to his position.
